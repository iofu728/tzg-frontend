window._bd_share_main ? window._bd_share_is_recently_loaded = !0 : (window._bd_share_is_recently_loaded = !1, window._bd_share_main = {
    ...
    e.onload = e.onerror = e.onreadystatechange = function () {
      if (/loaded|complete|undefined/.test(e.readyState)) {
        ...
        if (e.parentNode) {
          ...
          try {
            if (e.clearAttributes) {e.clearAttributes();} else {for (const n in e) {delete e[n];}}
          } catch (r) {
          }
        }
        e = undefined, t && t();
  ...
  function f (e, t) {
    e.attachEvent ? e.attachEvent('onload', t) : setTimeout(() => {
      l(e, t);
    }, 0);
  }
  ...
  function l (e, t) {
    ...
    let n,
      ...
      s = ~r.indexOf('Opera');
    if (i || s) {e.sheet && (n = !0);} else if (e.sheet) {
      try {
  ...
  e.each = r, i.currentPath = '', i.loadedPaths = {}, i.loadingPaths = {}, i.cache = {}, i.paths = {}, i.handlers = [], i.moduleFileMap = {}, i.requiredPaths = {}, i.lazyLoadPaths = {}, i.services = {}, i.isPathsLoaded = function (e) {
    ...
    if (r) {
      if (!r._inited) {
        ...
        let s,
          o = r.svnMod;
        if (s = r.fn.call(null, e => i.require(e, o), r.exports, new h(r.name, o))) {r.exports = s;}
      }
      return r.exports;
    }
    ...
    load () {
      ...
      this.type = u ? 'css' : 'js';
      const a = `/${this.type}/${i.moduleFileMap[t][this.name]}`;
      ...
      const n = t ? this._requiredStack : this._readyStack;
      if (e) {this._loaded ? e() : n.push(e);} else {
        ...
        if (this._readyStack && this._readyStack.length > 0) {
          ...
          let s,
            o = this.svnMod;
          this.fn && (s = this.fn.call(null, e => i.require(e, o), this.exports, new h(this.name, o))) && (this.exports = s), r(this._readyStack, e => {
            e();
          }), delete this._readyStack;
        }
        this._requiredStack && this._requiredStack.length > 0 && (r(this._requiredStack, e => {
          e();
      ...
      let e = this,
        ...
        n = this.path,
        s = [];
      t || (t = this.getDependents()), t.length ? (r(t, t => {
        s.push(i.getJsPath(t, e.path));
      }), r(t, t => {
        const n = i.get(t, e.path);
        n.ready(() => {
  ...
  var s = {
    create (e) {
      ...
      this._paths[t] = !0, r(this._rules, e => {
        t = e.call(null, t);
      }), u(t, e.type, e.loaded);
    }, _paths: {}, _rules: [], addPathRule (e) {
      this._rules.push(e);
    },
  };
  ...
  e._setMod = function (e) {
    ...
    const i = [];
    for (let s = 2, o = arguments.length; s < o; s++) {i.push(arguments[s]);}
    e.use(t, function (e) {
      const t = n.split('.');
      for (let r = 0, s = t.length; r < s; r++) {e = e[t[r]];}
      e && e.apply(this, i);
    });
  }, e._setContext = function (e) {
    typeof e === 'object' && r(e, (e, t) => {
  ...
  return h.prototype = {
    domain: window._bd_share_main.jscfg.domain, use (t, n) {
      typeof t === 'string' && (t = [t]);
      for (let r = t.length - 1; r >= 0; r--) {t[r] = `${this.svnMod}:${t[r]}`;}
      e.use(t, n);
    },
    ...
    const s = i.services[t];
    if (!s) {throw new Error(`${t} mod didn't define any services`);}
    const o = s[n];
    if (!o) {throw new Error(`${t} mod didn't provide service ${n}`);}
    e.use(`${t}:${o}`, r);
  }, e;
}({}))), !window._bd_share_is_recently_loaded && window._bd_share_main.F.module('base/min_tangram', (e, t) => {
  const n = {};
  ...
  n.extend = function () {
    const e = arguments[0];
    for (let t = 1, n = arguments.length; t < n; t++) {r(e, arguments[t]);}
    return e;
  }, n.domready = function (e, t) {
    t = t || document;
    if (/complete/.test(t.readyState)) {e();} else if (t.addEventListener) {t.readyState == 'interactive' ? e() : t.addEventListener('DOMContentLoaded', e, !1);} else {
      var n = function () {
        n = new Function(), e();
      };
      void (function () {
        ...
        t.readyState == 'complete' && n();
      });
    }
  }, n.isArray = function (e) {
    return Object.prototype.toString.call(e) == '[object Array]';
  }, t.T = n;
}), !window._bd_share_is_recently_loaded && window._bd_share_main.F.module('base/class', (e, t, n) => {
  const r = e('base/min_tangram').T;
  ...
  i.create = function (e, n) {
    return n = n || t.BaseClass, function () {
      ...
      const i = r.extend({}, this);
      e.apply(this, arguments), this._super = i;
    };
  }, t.Class = i;
}), !window._bd_share_is_recently_loaded && window._bd_share_main.F.module('conf/const', (e, t, n) => {
...
}()), !window._bd_share_is_recently_loaded && window._bd_share_main.F.use('base/min_tangram', e => {
  function n (e, t, n) {
    const r = new e(n);
  ...
  function r (e, r) {
    window._bd_share_main.F.use(e, (e, i) => {
      t.isArray(r) ? t.each(r, (t, r) => {
        n(e.Api, i.View, r);
      }) : n(e.Api, i.View, r);
    });
  }
  ...
  function i (e) {
    let n = e.common || window._bd_share_config && _bd_share_config.common || {},
      r = {
        like: { type: 'like' },
    ...
    return t.each(['like', 'share', 'slide', 'image', 'selectShare'], (s, o) => {
      e[o] && (t.isArray(e[o]) && e[o].length > 0 ? t.each(e[o], (s, u) => {
  ...
  _bd_share_main.init = function (e) {
    ...
    window._bd_share_main.n2 = (new Date()).getTime() + 1e3, _bd_share_main.init(), setTimeout(() => {
      window._bd_share_main.F.use('trans/logger', e => {
        e.nsClick(), e.back(), e.duration();
      });
    }, 3e3);
  });
}), !window._bd_share_is_recently_loaded && window._bd_share_main.F.module('component/comm_tools', (e, t) => {
  let n = function () {
      const e = window.location || document.location || {};
      return e.href || '';
    },
    r = function (e, t) {
      let n = e.length,
        r = '';
      for (let i = 1; i <= t; i++) {
        const s = Math.floor(n * Math.random());
        r += e.charAt(s);
      }
      return r;
    },
    i = function () {
      let e = (Number(new Date())).toString(36),
        t = r('0123456789abcdefghijklmnopqrstuvwxyz', 3);
      return e + t;
    };
  t.getLinkId = i, t.getPageUrl = n;
}), !window._bd_share_is_recently_loaded && window._bd_share_main.F.module('trans/trans', (e, t) => {
  var n = e('component/comm_tools'),
    r = e('conf/const').URLS,
    i = function () {
      window._bd_share_main.F.use('base/tangram', e => {
        const t = e.T;
        t.cookie.get('bdshare_firstime') == null && t.cookie.set('bdshare_firstime', Number(new Date()), {
          path: '/',
    ...
    s = function (e) {
      let t = e.bdUrl || n.getPageUrl();
      return t = t.replace(/\'/g, '%27').replace(/\"/g, '%22'), t;
    },
    o = function (e) {
      let t = (new Date()).getTime() + 3e3,
        r = {
          click: 1,
          url: s(e),
          uid: e.bdUid || '0',
      ...
      window._bd_share_main.F.use('trans/logger', t => {
        t.commit(e, r);
      });
    },
    u = function (e, t) {
    ...
    l = function (e) {
      window._bd_share_main.F.use('base/tangram', t => {
        const r = t.T;
    ...
    h = function () {
      window._bd_share_main.F.use('trans/trans_bdxc', e => {
        e && e.run();
      });
    },
    p = function (e) {
      window._bd_share_main.F.use('trans/trans_bdysc', t => {
        t && t.run(e);
      });
    },
    d = function (e) {
      window._bd_share_main.F.use('trans/trans_weixin', t => {
        t && t.run(e);
      });
    },
    v = function (e) {
